...
const AccountCard = props => {
  ...
  return (
    <Card className={classes.card}>
      <CardContent>
        <Typography className={classes.title}>{`${props.data.firstName ||
          props.data.name}`}</Typography>
        {props.data.account.balance && (
          <Typography className={classes.content}>{`Balance: ${props.data
            .account.balance || props.data.card.balance}`}</Typography>
        )}
        <Typography className={classes.content}>{`IBAN: ${props.data.account
          .iban || props.data.card.iban}`}</Typography>
      </CardContent>
